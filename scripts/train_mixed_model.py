...
output_name = 'pretrain_alexnet_letter_3copies'   # base name for various outputs, like the print log and the saved model
...
seed = 0 
lr = .00005
batch_size = 800 # size of training minibatches
test_batch_size = 800 # size of test minibatches
...
num_letter_copies = 3    # number of times to copy each letter image in dataset, 
...
model_path = '../models/mixednet/pretrain_alexnet_letter_3copies_ep2_imnet0.468_letter0.967.pt'
...
if __name__ == '__main__':
	...
	train_loader = torch.utils.data.DataLoader(
			data_classes.mix_imagenet_letter_data(train=True),
			batch_size=batch_size, shuffle=True, **kwargs)

	test_loader = torch.utils.data.DataLoader(
			data_classes.mix_imagenet_letter_data(train=False, size_vary=False),
